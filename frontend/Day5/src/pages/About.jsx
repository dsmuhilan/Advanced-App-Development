...
function About()
{
    return(
        ...
        <br></br>
        <h1>About</h1>
        <p>Welcome to the Learnify, your dedicated platform for academic success and holistic student well-being.</p>
        <div className="aboutcon">
        <img src={about1} style={{maxWidth:"15.8cm",marginTop:"1.2cm",maxHeight:"15cm"}}/>
        <div className="aboutcontainer">
        <h2>Our Mission</h2>
        <p>At the Learnify, we are committed to empowering students on their academic journey. Our mission is to provide comprehensive resources, foster a supportive community, and promote holistic development.</p>
